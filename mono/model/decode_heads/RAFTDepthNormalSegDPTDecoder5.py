...
class SegmentationHead(nn.Module):
    def __init__(self, in_channels=6, mid_channels=32, out_channels=1):
...
class AggregationNetwork(nn.Module):
    def __init__(self, in_channels=4, mid_channels=16, out_channels=1):
...
class RAFTDepthNormalSegDPT5(nn.Module):
