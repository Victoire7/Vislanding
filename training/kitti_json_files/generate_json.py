...
common_root = '/home/vector/Tan/xunfeidan/Metric3D/data/kitti'
depth_root = 'kitti_depth/data_depth_annotated'
raw_root = 'kitti_data'
...
with open('eigen_val_0.5k.txt') as f:
...
with open('eigen_val_small.json', 'w') as fj:
