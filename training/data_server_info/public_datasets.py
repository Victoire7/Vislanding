...
db_info['KITTI'] = {
    'db_root': 'data',
    'data_root': 'kitti',
    'train_annotations_path': 'kitti/eigen_train_small.json',
    'test_annotations_path': 'kitti/eigen_val_small.json',
    'val_annotations_path': 'kitti/eigen_val_small.json',
}
...
db_info['DDOS'] = {
    'db_root': 'data',
    'data_root': 'DDOS',
    'train_annotations_path': 'DDOS/ddos_train.json',
    'test_annotations_path': 'DDOS/ddos_test.json',
    'val_annotations_path': 'DDOS/ddos_validation.json',
}

db_info['WildUAV'] = {
    'db_root': 'data',
    'data_root': 'MDE/WildUAV',
    'train_annotations_path': 'WildUAV/wild_labled_train.json',
    'test_annotations_path': 'WildUAV/wild_labled_val.json',
    # 'test_annotations_path': 'WildUAV/wild_labled_train.json',
    'val_annotations_path': 'WildUAV/wild_labled_val.json',
    'unlabeled_annotations_path': 'WildUAV/wild_unlabled.json',
    'hdf5_path': "wilduav_labeld.hdf5"
}

db_info['Safe_WildUAV'] = {
    'db_root': 'data',
    'data_root': 'MDE/WildUAV',
    'train_annotations_path': 'WildUAV/wild_labled_train_4xr_safe.json',
    'test_annotations_path': 'WildUAV/wild_labled_val_4xr_safe.json',
    'val_annotations_path': 'WildUAV/wild_labled_val_4xr_safe.json'
}

db_info['Unlabel_Safe_WildUAV'] = {
    'db_root': 'data',
    'data_root': 'MDE/WildUAV',
    'train_annotations_path': 'WildUAV/wild_unlabled.json'
}

db_info['NewUnlabel_Safe_WildUAV'] = {
    'db_root': 'data',
    'data_root': 'MDE/WildUAV',
    'train_annotations_path': 'WildUAV/wild_unlabled.json'
}
...
db_info['MidAir'] = {
    'db_root': 'data',
    'data_root': 'MDE/MidAir/',
    'train_annotations_path': 'MDE/MidAir/train_midair.json',
    'test_annotations_path': 'MDE/MidAir/val_midair.json',
    'val_annotations_path': 'MDE/MidAir/val_midair.json'
}

db_info['SD'] = {
    'db_root': 'data',
    'data_root': 'MDE/Semantic_Drone_Dataset',
    'train_annotations_path': 'MDE/Semantic_Drone_Dataset/sd_safe_dataset.json',
    'test_annotations_path': 'MDE/Semantic_Drone_Dataset/sd_safe_dataset.json',
    'val_annotations_path': 'MDE/Semantic_Drone_Dataset/sd_safe_dataset.json'
}
