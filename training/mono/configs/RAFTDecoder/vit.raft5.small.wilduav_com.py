...
data_basic=dict(
    ...
    depth_range=(0, 1),
    depth_normalize=(10, 220),
#     crop_size=(544, 1216),
#     crop_size = (544, 992),
    clip_depth_range=(10, 220),
...
optimizer = dict(
    type='AdamW',
    encoder=dict(lr=1e-6, betas=(0.9, 0.999), weight_decay=0, eps=1e-10),
    decoder=dict(lr=1e-6, betas=(0.9, 0.999), weight_decay=0, eps=1e-10),
    strict_match = True
)
# optimizer = dict(
#     type='AdamW',
