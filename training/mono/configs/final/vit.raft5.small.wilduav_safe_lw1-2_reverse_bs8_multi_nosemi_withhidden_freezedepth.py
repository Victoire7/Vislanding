...
losses = dict(
    decoder_losses=[
        ...
        dict(type='SemiSafeEntropyLoss', loss_weight=1, use_conf=False, class_weight=[1.0, 2.0], final_only=False,
             loss_raw_size=False),
    ],
)
...
optimizer = dict(
    ...
    decoder=dict(lr=2e-5, betas=(0.9, 0.999), weight_decay=0, eps=1e-10),
