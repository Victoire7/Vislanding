...
losses = dict(
    decoder_losses=[
        ...
        dict(type='SemiSafeEntropyLoss', loss_weight=1, use_conf=False, class_weight=[2.0, 1.0], final_only=False,
             loss_raw_size=True),
    ],
)
...
use_kl = False
semi_weight = 2.0
flow_ablation = [True, True, False]  # depth, normal, fuse_feature
evaluation = dict(
    online_eval=True,
...
lr_config = dict(policy='poly',
                 ...
                 warmup_iters=20,
                 warmup_ratio=1e-6,
                 power=0.9, min_lr=2e-5, by_epoch=False)
# lr_config = dict(policy='poly',
#                  warmup='linear',
#                  warmup_iters=500,
#                  warmup_ratio=1e-6,
