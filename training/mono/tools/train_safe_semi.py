...
from mono.utils.do_train_safe_semi import do_train_safe_semi


def parse_args():
    parser = argparse.ArgumentParser(description='Train a segmentor')
    parser.add_argument('--config', help='train config file path', default='/home/vector/Tan/xunfeidan/Metric3D/training/mono/configs/semi/vit.raft5.small.wilduav_safe_newsemi_test.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models')
    parser.add_argument('--tensorboard-dir', help='the dir to save tensorboard logs')
    parser.add_argument(
        '--load-from', help='the checkpoint file to load weights from', default='/home/vector/Tan/xunfeidan/Metric3D/training/work_dirs/vit.raft5.small.wilduav_semi_new/20250212_214200/best_depth_ckpt/student_step00019800_0.0987.pth')
    parser.add_argument(
...
def main_worker(local_rank: int, cfg: dict, launcher: str='slurm'):
    ...
    do_train_safe_semi(local_rank, cfg)
