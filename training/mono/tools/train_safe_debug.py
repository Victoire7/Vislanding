...
from mono.utils.do_train_safe import do_train_safe


def parse_args():
    parser = argparse.ArgumentParser(description='Train a segmentor')
    parser.add_argument('--config', help='train config file path', default='mono/configs/RAFTDecoder/vit.raft5.small.wilduav_safe_test.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models')
    parser.add_argument('--tensorboard-dir', help='the dir to save tensorboard logs')
    parser.add_argument(
        '--load-from', help='the checkpoint file to load weights from', default='/home/vector/Tan/xunfeidan/Metric3D/weight/metric_depth_vit_small_800k.pth')
    parser.add_argument(
