...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path', default='/home/vector/Tan/xunfeidan/Metric3D/training/mono/configs/RAFTDecoder/vit.raft5.small.wilduav_safe.py')
